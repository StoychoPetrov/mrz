...
public class TessBaseAPI {
     ...
     * is (usually) an ISO 639-3 string or <code>null</code> will default to en.
     ...
     * that multiple languages are to be loaded. Eg hin+en will load Hindi and
     * English. Languages may specify internally that they want to be loaded
     * with one or more other languages, so the ~ sign is available to override
     * that. Eg if hin were set to load en by default, then hin+~en would force
     ...
     * returned. If hin loaded en automatically as well, then that will
